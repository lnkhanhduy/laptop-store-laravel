        ...
        var bx = bt(
            ...
            bF = bt(function (a, b, c, d, e, f, g, h) {
                ...
                z(l) > "1e12" && (l = 0.5),
                    ...
                    l > 0 &&
                        l < 1 &&
                        ((q = bE(a, b, c, d, e, f, g, h, l)),
                        p.push(q.x),
                        o.push(q.y)),
                    n > 0 &&
                        n < 1 &&
                        ((q = bE(a, b, c, d, e, f, g, h, n)),
                        p.push(q.x),
                        o.push(q.y)),
                    (i = f - 2 * d + b - (h - 2 * f + d)),
                    (j = 2 * (d - b) - 2 * (f - d)),
            ...
            bG = (a._path2curve = bt(
                function (a, b) {
                    ...
                    for (
                        var j = 0, k = x(c.length, (d && d.length) || 0);
                        j < k;
                        j++
                    ) {
                        (c[j] = g(c[j], e)),
