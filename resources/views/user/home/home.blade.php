...
<div>
        ...
        <div class="carousel-inner h-100">
            ...
            <div class="carousel-item {{$key == 0 ? 'active' : ''}} h-100">
                <img src="{{URL::to('/public/uploads/banner/'.$banner_value->banner_image)}}"
                    class="d-block w-100 h-100 object-fit-cover" alt="{{$banner_value->banner_name}}">
            </div>
            @endforeach
        </div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-9">
            <div class="container">
                <h2 class="text-title">Sản phẩm mới nhất</h2>
                <div class="row mt-4">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if ("{{Session::get('message')}}" != "") {
            show_alert('<i class="fa-solid fa-circle-check"></i>', "{{Session::get('message')}}", 'success');
            "{{Session::put('message', '')}}";
        }
    })
</script>
