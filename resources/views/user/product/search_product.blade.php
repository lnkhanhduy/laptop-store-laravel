    ...
    <div class="col-9">
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                <h2 class="text-title text-start flex-grow-1 d-flex align-items-center">Tìm kiếm sản phẩm</h2>
                <div>
            ...
            <div class="row mt-4" id="list-product">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function get_product(data, url = "{{URL::to('/search-product-user')}}") {
            $.ajax({
                type: "GET",
                url,
                data,
