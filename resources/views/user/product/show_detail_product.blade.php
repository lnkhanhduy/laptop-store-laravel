...
<div class="row">
    ...
    <div class="col-9">
        ...
        <div class="container">
            ...
            <div class="mt-4 row">
                <div class="col-5">
                    <ul id="gallery-image-detail">
                        <li data-thumb="{{URL::to('/public/uploads/product/'.$product->product_image)}}"
                            data-src="{{URL::to('/public/uploads/product/'.$product->product_image)}}">
                            <img style="width: 100%;"
                                src="{{URL::to('/public/uploads/product/'.$product->product_image)}}">
                        </li>
                        @foreach ($gallery as $image)
                        <li data-thumb="{{URL::to('/public/uploads/gallery/'.$image->gallery_image)}}"
                            data-src="{{URL::to('/public/uploads/gallery/'.$image->gallery_image)}}">
                            <img style="width: 100%;"
                                src="{{URL::to('/public/uploads/gallery/'.$image->gallery_image)}}">
                        </li>
                        @endforeach
                    </ul>
                </div>
                <div class="col-7">
                    ...
                    <div class="d-flex mt-3">
                        <button class="btn btn-primary col-4">Mua ngay</button>
                        <button class="btn btn-outline-primary ms-2 col-4 btn-add-cart"
            ...
            <div class="mt-4 border pb-4">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#detail-product-content">Chi tiết</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content mt-3 px-3">
                    ...
                    <div class="tab-pane container fade" id="detail-product-content">
                    ...
                    <div class="card h-100">
                        <a href="{{URL::to('/chi-tiet-san-pham/'.$related_product_value->product_slug)}}" class="h-100">
                            <img src="{{URL::to('/public/uploads/product/'.$related_product_value->product_image)}}"
                                class="card-img-top object-fit-cover" height="170px"
