...
<div class="">
    ...
    <div class="">
        <div class="d-md-flex align-items-center">
            <h2 class="text-title text-start flex-grow-1 d-flex align-items-center">Sản phẩm theo thương hiệu</h2>
...
$(document).ready(function() {
    ...
    function get_product(data, url = "{{URL::to('/get-product-by-brand-user')}}") {
        $.ajax({
            type: "GET",
            url,
            data,
